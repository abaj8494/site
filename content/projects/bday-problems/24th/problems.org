...
normal version
{{< m2sol >}}
this is an <strong>empty</strong> solution environment
{{< /m2sol >}}
...
hard version
{{< m2sol >}}
I am <em>testing</em> a large amount of the functionality
{{< /m2sol >}}
...
{{< m2prob >}}
Prove that there are equally as many <strong>integers</strong> as there are <strong>rational numbers</strong>, i.e. that \(|\mathbb{Q}| = |\mathbb{R}|\).
{{< m2sol >}}
{{< /m2sol >}}
maybe alpha lists:
<ol>
