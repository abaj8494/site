...
&\implies \cfrac{1}{1+exp(-\sum_j w_jx_j -b)}
\end{align*}\]
...
#+INCLUDE: "/code/10khrs-ai-ml-dl/PRACTISE/nielsen-dl/ch1-network.py" src python

#+INCLUDE: "/code/10khrs-ai-ml-dl/PRACTISE/nielsen-dl/mnist_loader.py" src python
