...
*Note:* The unticked pages _do not_ come with warranty. You may be mislead; @@html:<font color="#0071c5">\(\mathfrak{hic\,\,sunt\,\,dracones}\)</font>@@.
  
You may view the entire =tag= taxonomy [[/tags][here]], and the =author= taxonomy [[/author][here]].
...
- @@html:<input type="checkbox" class="edit"/>@@ [[/projects/ccs/dsa/leetcode][Leetcode]] {{< tags-inline "projects/ccs/dsa/leetcode" >}}
...
- @@html:<input type="checkbox" checked class="done"/>@@ [[/projects/ccs/programming/paradigms/object-oriented][Object-oriented]] {{< tags-inline "projects/ccs/programming/paradigms/object-oriented" >}}
...
** [[/projects/se][Software Engineering]]
:PROPERTIES:
:CUSTOM_ID: software-engineering
:END:

*** [[/projects/se/architecture-design][Architecture & Design]]
:PROPERTIES:
:CUSTOM_ID: architecture-design
:END:

- @@html:<input type="checkbox" checked class="refactor"/>@@ [[/projects/se/architecture-design/design-principles][Design Principles]] {{< tags-inline "projects/se/architecture-design/design-principles" >}}
- @@html:<input type="checkbox" checked class="refactor"/>@@ [[/projects/se/architecture-design/patterns-smells][Design Patterns & Smells]] {{< tags-inline "projects/se/architecture-design/patterns-smells" >}}
- @@html:<input type="checkbox" class="nothing"/>@@ [[/projects/se/architecture-design/microservices][Microservices]] {{< tags-inline "projects/se/architecture-design/microservices" >}}
- @@html:<input type="checkbox" class="nothing"/>@@ [[/projects/se/architecture-design/event-driven][Event Driven]] {{< tags-inline "projects/se/architecture-design/event-driven" >}}
- @@html:<input type="checkbox" class="nothing"/>@@ [[/projects/se/architecture-design/api][API Design]] {{< tags-inline "projects/se/architecture-design/api" >}}


*** [[/projects/se/implementation][Implementation]]
- @@html:<input type="checkbox" class="nothing"/>@@ [[/projects/se/implementation/build-systems][Build Systems]] {{< tags-inline "projects/se/implementation/build-systems" >}}
- @@html:<input type="checkbox" class="nothing"/>@@ [[/projects/se/implementation/concurrency][Concurrency]] {{< tags-inline "projects/se/implementation/concurrency" >}}
- @@html:<input type="checkbox" class="nothing"/>@@ [[/projects/se/implementation/containers][Containers]] {{< tags-inline "projects/se/implementation/containers" >}}

*** [[/projects/se/testing][Testing]]
...
- @@html:<input type="checkbox" checked class="archived"/>@@ [[/projects/ml/supervised/classification/perceptron][Perceptron (Sign Loss)]] {{< tags-inline "projects/ml/supervised/classification/perceptron" >}}
...
- @@html:<input type="checkbox" class="edit"/>@@ [[/projects/mathematics/analysis/functional][Functional Analysis]] {{< tags-inline "projects/mathematics/analysis/functional" >}}
