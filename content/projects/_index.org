...
@@html:<a href="[[https://abaj.games]]" style="display: inline-block; border: none;"><img width="500" src="{{< cwd >}}games.svg" style="display: block; border: none;"></a>@@
#+END_CENTER
...
- @@html:<input type="checkbox" class="edit"/>@@ [[/projects/ai/ethics/gpt3][Value Sensitive Design of GPT3 Series]] {{< tags-inline "projects/ai/ethics/gpt3" >}}
...
- @@html:<input type="checkbox" checked class="refactor"/>@@ [[/projects/ml/dl/feedforward][Feedforward Neural Networks]]  {{< tags-inline "projects/ml/dl/feedforward" >}}
