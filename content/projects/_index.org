...
:CUSTOM_ID: data-algs
:END:
- @@html:<input type="checkbox" class="nothing"/>@@ [[/projects/ccs/data-algs/advanced][Advanced Algorithms]] {{< tags-inline "projects/ccs/data-algs/adv-alg" >}}
...
:CUSTOM_ID: languages
:END:
- @@html:<input type="checkbox" class="nothing"/>@@ [[/projects/ccs/programming/languages/python][Python]] {{< tags-inline "projects/ccs/programming/languages/python" >}}
