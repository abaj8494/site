...
*** Data Structures _&_ Algorithms
- @@html:<input type="checkbox" class="nothing"/>@@ [[/projects/ccs/data-algs/adv-alg][Advanced Algorithms]] {{< tags-inline "projects/ccs/data-algs/adv-alg" >}}
...
- @@html:<input type="checkbox" checked class="archived"/>@@ [[/projects/csp/rpi/kiyomi][RPI3]] {{< tags-inline "projects/csp/rpi/kiyomi" >}}
- @@html:<input type="checkbox" checked class="archived"/>@@ [[/projects/csp/rpi/rpi][RPI4]] {{< tags-inline "projects/csp/rpi/rpi" >}}
