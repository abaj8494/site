...
2. If $\set{V_i}_{i\in I} \subseteq \mathcal{O}(X)$, then $\displaystyle \bigcup_{i\in I} V_i \in \mathcal{O}(X)$. @@html:<span class="margin-note" data-note="the union of open sets is open"> <span class="margin-note-indicator">𐃏</span> </span>@@
3. If $V_1, V_2 \in \mathcal{O}(X)$, then $V_1 \cap V_2 \in \mathcal{O}(X)$ @@html: <span class="margin-note" data-note="a <strong>finite</strong> intersection of open sets is open"> <span class="margin-note-indicator">𐃏</span> </span>@@
{{< /mthm >}}
